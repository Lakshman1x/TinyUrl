...
public interface ITinyUrlController {
    ...
    public ResponseEntity<String> upgradePlan(AppUserDetails user);
    public ResponseEntity<String> getTinyUrl(TinyUrlDto dto, BindingResult result,AppUserDetails user)
